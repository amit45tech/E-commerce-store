...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        if (check.equals("settings"))
        {
            ...
            questionTitle.setText("Please set Answers for the following secutity questions?");
            ...
            ref.child("Security Questions").updateChildren(userdataMap)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this, "You have set Security Question.", Toast.LENGTH_SHORT).show();
                    ...
                    if (dataSnapshot.exists())
                    {
                        ...
                        if (dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            else
                            {
                                ...
                                newPassword.setHint("Enter Password here...");
                        ...
                        Toast.makeText(ResetPasswordActivity.this, "Mobile Number Does not Exists!", Toast.LENGTH_SHORT).show();
                    }
