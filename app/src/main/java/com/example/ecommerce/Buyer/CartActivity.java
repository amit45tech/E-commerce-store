    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(CartActivity.this, LoginActivity.ConfirmFinalOrderActivity.class);
           ...
           public void onDataChange(DataSnapshot dataSnapshot)
           {
               if (dataSnapshot.exists())
               {
                   ...
                   if (shippingStatus.equals("shipped"))
                   {
                       ...
                       txtMsg1.setText("Congratulations, Your final order has been shipped successfully and your will receive your order soon at your door step. Thank Your!");
