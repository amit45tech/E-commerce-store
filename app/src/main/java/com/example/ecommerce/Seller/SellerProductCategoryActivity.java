...
public class SellerProductCategoryActivity extends AppCompatActivity {
    ...
    private ImageView headPhoneHandFree, Laptos, watches, mobilePhones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headPhoneHandFree = (ImageView) findViewById(R.id.headphonea_handfree);
        Laptos = (ImageView) findViewById(R.id.laptop_pc);
        ...
        Laptos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                Intent intent = new Intent(SellerProductCategoryActivity.this, SellerAddNewProductActivity.class);
