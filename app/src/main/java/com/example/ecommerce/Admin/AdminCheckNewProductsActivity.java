...
public class AdminCheckNewProductsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView = findViewById(R.id.admin_product_check_list);
    ...
    private void ChangeProductState(String productID)
    {
        unverifiedProductRef.child(productID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    {
                        Toast.makeText(AdminCheckNewProductsActivity.this, "Item has been approved, and Available for the sale.", Toast.LENGTH_SHORT).show();
